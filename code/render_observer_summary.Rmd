...
if(max(historic_phenology4plot$year) - min(historic_phenology4plot$year) > 5) {
  zyears <- seq((floor(min(historic_phenology4plot$year, na.rm = TRUE)/5)*5), (ceiling(historic_phenology4plot$zyear/5)*5), by = 5)
} else {
...
if(max(historic_productivity4plot$year) - min(historic_productivity4plot$year) > 5) {
  zyears <- seq((floor(min(historic_productivity4plot$year, na.rm = TRUE)/5)*5), (ceiling(historic_productivity4plot$zyear/5)*5), by = 5)
} else {
