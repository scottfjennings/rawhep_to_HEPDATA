...
render_season_summary <- function(file = "https://github.com/scottfjennings/Survey123_to_HEPDATA/blob/main/code/step2_wrangled_s123_to_season_summary.Rmd?raw=TRUE", zyear, zcode, zspp) {
